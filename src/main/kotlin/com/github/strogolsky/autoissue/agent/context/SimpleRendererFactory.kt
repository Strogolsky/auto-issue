...
class SimpleRendererFactory : RendererFactory {
    ...
    override fun render(component: ContextComponent): String = when (component) {
    ...
    private fun renderFileContext(c: FileContextComponent): String = buildString {
    ...
    private fun renderJiraMetadata(m: JiraProjectMetadata): String = buildString {
