...
object MaskingPatterns {
    ...
    val BEARER_TOKEN = MaskingPattern(
        regex = Regex(
    ...
    val ALL: List<MaskingPattern> = listOf(
        BEARER_TOKEN,
