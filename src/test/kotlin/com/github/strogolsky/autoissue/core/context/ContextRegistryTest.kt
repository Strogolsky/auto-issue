...
class ContextRegistryTest {
    ...
    @Test
    fun should_ReturnEmptyList_When_RegistryIsEmpty() =
        runTest {
            // 1. ARRANGE
    ...
    @Test
    fun should_ReturnComponent_When_ProviderIsRegistered() =
        runTest {
            // 1. ARRANGE
    ...
    @Test
    fun should_IgnoreNull_When_ProviderReturnsNull() =
        runTest {
            // 1. ARRANGE
            val provider = mockk<ContextComponentProvider>()
    ...
    @Test
    fun should_ReturnAllComponents_When_MultipleProvidersRegistered() =
        runTest {
            // 1. ARRANGE
    ...
    @Test
    fun should_SkipProviderAndContinue_When_ProviderThrowsException() =
        runTest {
            // 1. ARRANGE
